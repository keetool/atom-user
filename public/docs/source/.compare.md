...
<!-- START_bf44e8850ecd91d57f2035ebebb01328 -->
## client-api/v1/dashboard

> Example request:

```bash
curl -X GET "https://atomuser.com/client-api/v1/dashboard" \
-H "Accept: application/json"
```
...
var settings = {
    "async": true,
    "crossDomain": true,
    "url": "https://atomuser.com/client-api/v1/dashboard",
    "method": "GET",
    "headers": {
        "accept": "application/json"
    }
...
### HTTP Request
`GET client-api/v1/dashboard`

`HEAD client-api/v1/dashboard`
